...
public class HR_Manager_D extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Create New Employee accounts");
        ...
        jButton2.setText("Create New Departments");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HR_Manager_D().setVisible(true);
            }
        });
    }
