...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Create account for a new HR Assistant");
        ...
        jButton2.setText("Create account for a new HR Manager");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        HR_Assistent_N LoginFrame=new HR_Assistent_N();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        HR_Manager_N LoginFrame=new HR_Manager_N();
        LoginFrame.setVisible(true);
        LoginFrame.pack();
        LoginFrame.setLocationRelativeTo(null); // TODO add your handling code here:
